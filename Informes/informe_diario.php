...
//BASE DE DATOS
	...
	/*
	if( ($meta_mini == '' or $meta_mini < 1) or ($meta_pino == '' or $meta_pino < 1) or ($meta_macro == '' or $meta_macro < 1) ){
		echo "<br>Existen parámetros mensuales incorrectos en el informe diario, favor corregir: <a href='http://ing-worlds.cl/proyecto/sisconvi-production/ges_parmes.php'>Parámetros Mensuales</a>";
		exit();
	}*/
