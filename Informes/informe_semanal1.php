...
if(empty($_GET['per_agno']) or empty($_GET['per_mes']) or empty($_GET['sem_num'])){
	...
	if($sem_num == -1){
		...
		print_r($ultimo_dia);
		echo '<br><br>';		
		print_r($SEM_FECHAINI_INF);
		echo '<br><br>';		
		print_r($SEM_FECHAFIN_INF);
		echo '<br><br>';		
		print_r($SEM_FECHAINI_INF_PRINT);
		echo '<br><br>';		
		print_r($SEM_FECHAFIN_INF_PRINT);
		echo '<br><br>';*/		
	}
	else{
...
<hr>		
		...
		<div class="rowx">
		  <center><div class="col-md-2x"><div id="chart-container4"></div></div></center>
		  <center><div class="col-md-2x"><div id="chart-container5"></div></div></center>
		  <center><div class="col-md-2x"><div id="chart-container6"></div></div></center>
		  <center><div class="col-md-2x"><div id="chart-container7"></div></div></center>
		  <center><div class="col-md-2x"><div id="chart-container8"></div></div></center>
		  <center><div class="col-md-2x"><div id="chart-container9"></div></div></center>
		</div>	


		<div class="rowx">
		  <center><div class="col-md-2x"><span style="font-size:11px; font-weight:bold">Dotación:</span> <?php echo $cant_operador[0]; ?></div></center>
		  <center><div class="col-md-2x"><span style="font-size:11px; font-weight:bold">Dotación:</span> <?php echo $cant_operador[1]; ?></div></center>
		  <center><div class="col-md-2x"><span style="font-size:11px; font-weight:bold">Dotación:</span> <?php echo $cant_operador[2]; ?></div></center>
		  <center><div class="col-md-2x"><span style="font-size:11px; font-weight:bold">Dotación:</span> <?php echo $cant_operador[3]; ?></div></center>
		  <center><div class="col-md-2x"><span style="font-size:11px; font-weight:bold">Dotación:</span> <?php echo $cant_operador[4]; ?></div></center>
		  <center><div class="col-md-2x"><span style="font-size:11px; font-weight:bold">Dotación:</span> <?php echo $cant_operador[5]; ?></div></center>
		</div>		

		<div class="rowx">
		  <center><div class="col-md-2x"><div id="chart-container10"></div></div></center>
		  <center><div class="col-md-2x"><div id="chart-container11"></div></div></center>
		  <center><div class="col-md-2x"><div id="chart-container12"></div></div></center>
		  <center><div class="col-md-2x"><div id="chart-container13"></div></div></center>
		  <center><div class="col-md-2x"><div id="chart-container14"></div></div></center>
		  <center><div class="col-md-2x"><div id="chart-container15"></div></div></center>
		</div>			
<!--
<hr>
...
<br><br>		
		<div class="row">
		  <?php $i = 0; while($i < $rowcount){ ?>	
		  <div class="col-md-2x" style="font-size:9px">
...
<br>
		<div class="row">
		  <center><div class="col-md-2x"><span style="font-size:11px; font-weight:bold">> 80% CUMPLIMIENTO:</span> <?php echo $operadores_80[0]; ?></div></center>
		  <center><div class="col-md-2x"><span style="font-size:11px; font-weight:bold">> 80% CUMPLIMIENTO:</span> <?php echo $operadores_80[1]; ?></div></center>
		  <center><div class="col-md-2x"><span style="font-size:11px; font-weight:bold">> 80% CUMPLIMIENTO:</span> <?php echo $operadores_80[2]; ?></div></center>
		  <center><div class="col-md-2x"><span style="font-size:11px; font-weight:bold">> 80% CUMPLIMIENTO:</span> <?php echo $operadores_80[3]; ?></div></center>
		  <center><div class="col-md-2x"><span style="font-size:11px; font-weight:bold">> 80% CUMPLIMIENTO:</span> <?php echo $operadores_80[4]; ?></div></center>
		  <center><div class="col-md-2x"><span style="font-size:11px; font-weight:bold">> 80% CUMPLIMIENTO:</span> <?php echo $operadores_80[5]; ?></div></center>
		</div>
<br>
...
<br>
		...
		<div class="row">
		  <center><div class="col-md-2x"><span style="font-size:11px; font-weight:bold">< 50% CUMPLIMIENTO:</span> <?php echo $operadores_50[0]; ?></div></center>
		  <center><div class="col-md-2x"><span style="font-size:11px; font-weight:bold">< 50% CUMPLIMIENTO:</span> <?php echo $operadores_50[1]; ?></div></center>
		  <center><div class="col-md-2x"><span style="font-size:11px; font-weight:bold">< 50% CUMPLIMIENTO:</span> <?php echo $operadores_50[2]; ?></div></center>
		  <center><div class="col-md-2x"><span style="font-size:11px; font-weight:bold">< 50% CUMPLIMIENTO:</span> <?php echo $operadores_50[3]; ?></div></center>
		  <center><div class="col-md-2x"><span style="font-size:11px; font-weight:bold">< 50% CUMPLIMIENTO:</span> <?php echo $operadores_50[4]; ?></div></center>
		  <center><div class="col-md-2x"><span style="font-size:11px; font-weight:bold">< 50% CUMPLIMIENTO:</span> <?php echo $operadores_50[5]; ?></div></center>
		</div>
	-->
<br>
</body>
