...
<hr>		
		...
		<div class="row">
		  <center><div class="col-md-2"><span style="font-size:11px; font-weight:bold">Dotación:</span> <?php echo $cant_operador[0]; ?></div></center>
		  <center><div class="col-md-2"><span style="font-size:11px; font-weight:bold">Dotación:</span> <?php echo $cant_operador[1]; ?></div></center>
		  <center><div class="col-md-2"><span style="font-size:11px; font-weight:bold">Dotación:</span> <?php echo $cant_operador[2]; ?></div></center>
		  <center><div class="col-md-2"><span style="font-size:11px; font-weight:bold">Dotación:</span> <?php echo $cant_operador[3]; ?></div></center>
		  <center><div class="col-md-2"><span style="font-size:11px; font-weight:bold">Dotación:</span> <?php echo $cant_operador[4]; ?></div></center>
		  <center><div class="col-md-2"><span style="font-size:11px; font-weight:bold">Dotación:</span> <?php echo $cant_operador[5]; ?></div></center>
		</div>		
