<?php 
	...
	if(isset($_POST['load_calendario'])){
		...
		//días inhábiles
		$sql = "SELECT DATE_FORMAT(DIAS,'%Y%m%d') as FECHA FROM DIAS_NOPROD WHERE per_agno = $per_agno";		
	...
	elseif(isset($_POST['update_diasnoprod'])){
		...
		//Delete per_agno
		$sql_del = "DELETE FROM DIAS_NOPROD WHERE PER_AGNO = $per_agno";
		...
		*/
			...
			$sql = "INSERT INTO DIAS_NOPROD(DIAS, PER_AGNO, SEM_NUM) VALUES ('$dia',$per_agno,$sem_num)";
