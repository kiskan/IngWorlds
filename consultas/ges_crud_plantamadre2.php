<?php 
	...
	elseif(isset($_GET['oper_rut'])){
		...
		$sql = "select p.pis_pm, p.pis_id, c.clon_id, po.pisop_cant from PISCINA_OPER po join PISCINA p on po.pis_pm = p.pis_pm and po.pis_id = p.pis_id join CLON c on p.clon_id = c.clon_id join PLANIFICACION_OPER plano on po.oper_rut = plano.oper_rut and po.plan_dia = plano.plan_dia and po.activ_id = plano.activ_id 
		WHERE
