...
<script type="text/javascript" src="js/inf_planmaestro.js"></script>
				...
				<div class="x_content">
					...
					<form id="form_sactiv" data-parsley-validate class="form-horizontal form-label-left">	
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<button id="btn_inf_planmaestro" type="button" class="btn btn-success">Informe</button>
