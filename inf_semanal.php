...
<script type="text/javascript" src="js/inf_semanal.js"></script>
				...
				<div class="x_content">
					...
					<form id="form_sactiv" data-parsley-validate class="form-horizontal form-label-left">	
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<button id="btn_inf_semanal" type="button" class="btn btn-success">Informe</button>
								<!--<a class="btn btn-success" target="_blank" href="/proyecto/sisconvi-production2/Informes/informe_semanal.php">Informe</a>-->
								<a target="_blank" id="link_informe_semanal" style="display:none">Informe</a>
							</div>								
						</div>							
