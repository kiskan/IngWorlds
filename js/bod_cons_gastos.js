$(document).ready(function(){
	...
	*/
	...
	function crear_tabla(sprod_id, sprod_codigosap, sprod_estado, solicitante, per_agno, sem_num, sprod_dia, UNDVIV_ID, sprod_tipocompra, sprod_prioridad, sprod_tipomant, catprod_id, prod_cod, cc_id){
		//console.log(plan_dia)
		table = $('#datatable-scroll').DataTable( {
			ajax: "consultas/cons_gastos.php?totales=ok&sprod_id="+sprod_id+"&sprod_codigosap="+sprod_codigosap+"&sprod_estado="+sprod_estado+"&solicitante="+solicitante+"&per_agno="+per_agno+"&sem_num="+sem_num+"&sprod_dia="+sprod_dia+"&UNDVIV_ID="+UNDVIV_ID+"&sprod_tipocompra="+sprod_tipocompra+"&sprod_prioridad="+sprod_prioridad+"&sprod_tipomant="+sprod_tipomant+"&catprod_id="+catprod_id+"&prod_cod="+prod_cod+"&cc_id="+cc_id,
			deferRender:    true,
			scrollY:        500,
			scrollX:        true,
			scrollCollapse: true,
...
//CLICK CONSULTAR
	...
	function busqueda_solic(){
		...
		crear_tabla(sprod_id, sprod_codigosap, sprod_estado, solicitante, per_agno, sem_num, sprod_dia, UNDVIV_ID, sprod_tipocompra, sprod_prioridad, sprod_tipomant, catprod_id, prod_cod, cc_id)			
	}
