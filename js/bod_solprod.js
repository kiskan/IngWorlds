...
////////////TABLA PRODUCTOS/////////////////	
	...
	function crear_tabla_prod(nro_solicitud){
		...
		tabla_productos = $("#tabla_productos").DataTable({
			...
			columnDefs: [
			{ targets: [11,12,15,16], visible: true},
			{ targets: '_all', visible: false }						
			],
...
*/		
	...
	$('#btn_reg_prod').click(function(){
		...
		if (validar_prod()){	
			...
			$('#loading').show();
			$('#btn_reg_prod').prop('disabled',true);
 	...
 	$('#btn_upd_prod').click(function(){
		if (validar_prod()){	
			...
			$('#btn_del_prod').prop('disabled',true);
			$('#btn_can_prod').prop('disabled',true);
			$('#btn_upd_prod').prop('disabled',true);
			var sprod_id = $.trim($('#sprod_id').val());
 	...
 	$('#btn_del_sprod').click(function(){
		...
		swal({   
			...
			function(){   
				$('#loading').show();
				$('#btn_del_sprod').prop('disabled',true);
				var sprod_id = $.trim($('#sprod_id').val());
	...
	function bod_crud_solprod(resp){
		...
		$('#btn_reg_prod').prop('disabled',false);
		$('#btn_upd_prod').prop('disabled',false);
		$('#btn_del_prod').prop('disabled',false);
		$('#btn_del_sprod').prop('disabled',false);
		$('#btn_can_prod').prop('disabled',false);
