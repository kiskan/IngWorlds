$(document).ready(function(){
	...
	$('#btn_inf_planmaestro').click(function(){
		
		var per_agno = $('#per_agno').val();
		var per_mes = $('#per_mes').val();
		var sem_num = $('#sem_num').val();
		var url = '/proyecto/sisconvi-production/Informes/informe_planmaestro.php?per_agno='+per_agno+'&per_mes='+per_mes+'&sem_num='+sem_num;
