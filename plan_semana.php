				...
				<?php if(!$error){ ?>	
					...
					<form id="form_planxsemana" data-parsley-validate class="form-horizontal">	
						...
						<div class="form-group">
								...
								<button id="btn_ver_planxsemana" type="button" class="btn btn-success">Ver Disponibles</button>
								<br>								
						...
						<div class="col-xs-6">
							...
							<div class="table-responsive">
								<table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
									<thead>
										<tr>
											<th colspan="7" class="text-center">OPERADORES DISPONIBLES</th>
										</tr>			  
										<tr>
						...
						<div class="col-xs-6">
							...
							<div class="table-responsive">
								<table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
									<thead>
										<tr>
											<th colspan="7" class="text-center">JORNADAS DISPONIBLES</th>
										</tr>			  
										<tr>
											<th class="col-md-1" style="text-align:center">L</th>
											<th class="col-md-1" style="text-align:center">M</th>
						...
						<div class="col-xs-4">
							...
							<div class="table-responsive">
								<table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
									<thead>
										<tr>
											<th colspan="7" class="text-center">JORNADA SELECCIONADA</th>
										</tr>			  
										<tr>
											<th class="col-md-1" style="text-align:center">L</th>
											<th class="col-md-1" style="text-align:center">M</th>
						...
						<div class="col-xs-4">
							...
							<div class="table-responsive">
								<table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
									<thead>
										<tr>
											<th colspan="7" class="text-center">OPERADORES SELECCIONADOS</th>
										</tr>			  
										<tr>
											<th class="col-md-1" style="text-align:center">L</th>
											<th class="col-md-1" style="text-align:center">M</th>
						...
						<div class="col-xs-4">
							...
							<div class="table-responsive">
								<table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
									<thead>
										<tr>
											<th colspan="7" class="text-center">PRODUCCIÓN ESPERADA</th>
										</tr>			  
										<tr>
											<th class="col-md-1" style="text-align:center">L</th>
											<th class="col-md-1" style="text-align:center">M</th>
						...
						<div class="col-xs-6">
							...
							<div class="table-responsive">
								<table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%" style="font-size:11px !important">
									<thead>
										<tr>
											<th colspan="2"></th>
											<th colspan="7" class="text-center">DIAS CON CARGA DE TRABAJO</th>
										</tr>			  
										<tr>
