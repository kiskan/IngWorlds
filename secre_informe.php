...
<script type="text/javascript" src="js/secre_informe.js"></script>
...
<div class="right_col" role="main">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				<div class="x_title">
					<h2>Informe Actividades Fin de Semana y Feriados</h2>
				...
				<div class="x_content">
					...
					<form id="form_sactiv" data-parsley-validate class="form-horizontal form-label-left">	
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<button id="btn_secre_informe" type="button" class="btn btn-success">Informe</button>
							</div>								
						</div>							
